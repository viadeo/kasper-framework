...
public class RemovePermissionFromGroupCommandHandlerUTest {
    ...
    public void setUp() {
        ...
        RemovePermissionFromGroupCommandHandler commandHandler = new RemovePermissionFromGroupCommandHandler();
    ...
    @Test
    public void removePermissionFromGroup_shouldBeOk() {
        ...
        Group_has_Permission group_has_permission = Group_has_Permission.build(group, permission);
        ...
        when(authorizationStorage.getGroupHasPermission(group.getEntityId(), permission.getEntityId())).thenReturn(group_has_permission);
        when(authorizationStorage.removePermissionFromGroup(any(Group_has_Permission.class))).thenReturn(true);
        fixture.given()
                .when(new RemovePermissionFromGroupCommand(group.getEntityId(), permission.getEntityId()), context)
                .expectReturnOK()
                .expectExactSequenceOfEvents(
                        new AuthorizationPermissionRemovedFromGroupEvent(
