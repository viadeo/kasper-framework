...
public class RemoveRoleFromGroupCommandHandlerUTest {
    ...
    public void setUp() {
        ...
        RemoveRoleFromGroupCommandHandler commandHandler = new RemoveRoleFromGroupCommandHandler();
    ...
    @Test
    public void removeRoleFromGroup_shouldBeOk() {
        ...
        Group_has_Role group_has_role = Group_has_Role.build(group, role);
        ...
        when(authorizationStorage.getGroupHasRole(group.getEntityId(), role.getEntityId())).thenReturn(group_has_role);
        when(authorizationStorage.removeRoleFromGroup(any(Group_has_Role.class))).thenReturn(true);
        fixture.given()
                .when(new RemoveRoleFromGroupCommand(group.getEntityId(), role.getEntityId()), context)
                .expectReturnOK()
                .expectExactSequenceOfEvents(
                        new AuthorizationRoleRemovedFromGroupEvent(
