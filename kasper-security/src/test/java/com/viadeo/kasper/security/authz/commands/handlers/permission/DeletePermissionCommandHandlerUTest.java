...
public class DeletePermissionCommandHandlerUTest {
    ...
    public void setUp() {
        ...
        DeletePermissionCommandHandler commandHandler = new DeletePermissionCommandHandler();
    ...
    @Test
    public void deletePermissionWithGoodName_shouldBeOk() throws Exception {
        ...
        when(authorizationStorage.deletePermission(any(WildcardPermission.class))).thenReturn(true);

        fixture.given()
                .when(new DeletePermissionCommand(permission.getEntityId()), context)
                .expectReturnOK()
                .expectExactSequenceOfEvents(new AuthorizationPermissionDeletedEvent(permission.getEntityId()));
    }
