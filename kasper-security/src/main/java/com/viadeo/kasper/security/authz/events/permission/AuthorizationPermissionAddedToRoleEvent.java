...
public class AuthorizationPermissionAddedToRoleEvent extends EntityCreatedEvent<Authorization> {
    ...
    public AuthorizationPermissionAddedToRoleEvent(final RolePermissionAssociationId rolePermissionAssociationId, final Role role, final WildcardPermission permission) {
        super(rolePermissionAssociationId);
        this.role = role;
