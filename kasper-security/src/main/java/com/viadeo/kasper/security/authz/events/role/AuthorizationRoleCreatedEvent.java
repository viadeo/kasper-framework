...
public class AuthorizationRoleCreatedEvent extends EntityCreatedEvent<Authorization> {
    ...
    public AuthorizationRoleCreatedEvent(KasperID entityId) {
        super(checkNotNull(entityId));
    }

    public AuthorizationRoleCreatedEvent(KasperID entityId, String name) {
        super(entityId);
        this.name = checkNotNull(name);
        this.permissions = Lists.newArrayList();
    }

    public AuthorizationRoleCreatedEvent(KasperID entityId, String name, List<WildcardPermission> permissions) {
        super(entityId);
        this.name = checkNotNull(name);
