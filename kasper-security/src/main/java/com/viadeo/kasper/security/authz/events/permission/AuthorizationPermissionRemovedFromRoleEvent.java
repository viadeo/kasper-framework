...
public class AuthorizationPermissionRemovedFromRoleEvent extends EntityDeletedEvent<Authorization> {

    final KasperID entityId;

    // ------------------------------------------------------------------------

    public AuthorizationPermissionRemovedFromRoleEvent(final KasperID entityId) {
