...
public class AuthorizationPermissionDeletedEvent extends EntityDeletedEvent<Authorization>  {

    final KasperID entityId;

    // ------------------------------------------------------------------------

    public AuthorizationPermissionDeletedEvent(final KasperID entityId) {
