...
public class AuthorizationRoleRemovedFromUserEvent extends EntityDeletedEvent<Authorization> {

    final KasperID entityId;

    // ------------------------------------------------------------------------

    public AuthorizationRoleRemovedFromUserEvent(final KasperID entityId) {
