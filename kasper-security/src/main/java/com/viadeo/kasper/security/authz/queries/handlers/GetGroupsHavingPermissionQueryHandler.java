...
@XKasperQueryHandler(domain = Authorization.class, description = "get all authorization's groups for a given permission query handler")
public class GetGroupsHavingPermissionQueryHandler extends QueryHandler<GetGroupsHavingPermissionQuery, GroupsResult> {

    private final AuthorizationStorage authorizationStorage;

    public GetGroupsHavingPermissionQueryHandler(AuthorizationStorage authorizationStorage) {
