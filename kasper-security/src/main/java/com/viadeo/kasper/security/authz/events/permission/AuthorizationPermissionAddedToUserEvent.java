...
public class AuthorizationPermissionAddedToUserEvent extends EntityCreatedEvent<Authorization> {
    ...
    public AuthorizationPermissionAddedToUserEvent(final KasperID entityId, final User user, final WildcardPermission permission) {
        super(entityId);
        this.user = user;
