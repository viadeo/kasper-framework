...
public interface XKasperAuthz {
     ...
     * Each functions need the authorizations lists coming from {@link com.viadeo.kasper.api.domain.annotation.XKasperAuthz.RequiresPermissions} or
     * {@link com.viadeo.kasper.api.domain.annotation.XKasperAuthz.RequiresRoles} annotations, a {@link com.viadeo.kasper.api.domain.annotation.XKasperAuthz.CombinesWith} specifying
     * the operation (default "AND"), the current actor and an optional targetId (to which the permission holder) indicated by the
     * {@link com.viadeo.kasper.api.domain.annotation.XKasperAuthz.TargetId} annotation.
     *
     * @see com.viadeo.kasper.api.domain.annotation.XKasperAuthz.RequiresPermissions
     * @see com.viadeo.kasper.api.domain.annotation.XKasperAuthz.RequiresRoles
     * @see com.viadeo.kasper.api.domain.annotation.XKasperAuthz.CombinesWith
     * @see com.viadeo.kasper.api.domain.annotation.XKasperAuthz.TargetId
     */
