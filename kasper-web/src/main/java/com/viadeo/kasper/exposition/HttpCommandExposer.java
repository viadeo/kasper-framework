...
public class HttpCommandExposer extends HttpExposer {
    ...
    private void handleCommand(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    protected void sendResponse(ICommandResult result, HttpServletResponse resp, Class<? extends ICommand> commandClass)
            throws IOException {
    ...
    protected void sendError(HttpServletResponse response, int status, String reason) throws JsonGenerationException,
