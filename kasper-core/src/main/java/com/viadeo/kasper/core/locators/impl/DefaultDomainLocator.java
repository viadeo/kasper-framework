...
public class DefaultDomainLocator implements DomainLocator {
    ...
    /**
     * @see com.viadeo.kasper.core.locators.DomainLocator#getDomainEntities(com.viadeo.kasper.api.domain.Domain)
     */
    @Override
    @SuppressWarnings("unchecked")
    ...
    /**
     * @see com.viadeo.kasper.core.locators.DomainLocator#getDomainPrefix(com.viadeo.kasper.api.domain.Domain)
     */
    @Override
    ...
    /**
     * @see com.viadeo.kasper.core.locators.DomainLocator#getDomainName(com.viadeo.kasper.api.domain.Domain)
     */
    @Override
