...
public class DefaultIDTransformer implements IDTransformer {
    ...
    private static final Function<ID, String> GET_VENDOR_FUNCTION = id -> checkNotNull(id).getVendor();

    private static final Function<ID, Format> GET_FORMAT_FUNCTION = id -> checkNotNull(id).getFormat();
