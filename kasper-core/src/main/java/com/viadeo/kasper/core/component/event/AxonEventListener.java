...
public abstract class AxonEventListener<EVENT extends Event> implements org.axonframework.eventhandling.EventListener {
    ...
    public final EventResponse handleWithResponse(final EventMessage eventMessage) {
        ...
        return this.handle(new com.viadeo.kasper.core.component.event.EventMessage<EVENT>(eventMessage));
    }
    ...
    public abstract EventResponse handle(com.viadeo.kasper.core.component.event.EventMessage<EVENT> message);
