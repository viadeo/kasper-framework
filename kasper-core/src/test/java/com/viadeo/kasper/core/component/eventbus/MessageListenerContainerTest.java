...
public class MessageListenerContainerTest {
    ...
    public void executeListener_WithEventListenerClass_resetAndPopulateMdc() throws Throwable {
        ...
        assertEquals("MDC <appRoute> contains the fqn of passed event listener", "com.viadeo.kasper.core.component.eventbus.MessageListenerContainerTest$Foo", MDC.get("appRoute"));
    }
}