...
public class KasperRoutingKeyResolverUTest {
    ...
    public void subscribe_WithParentListener_CreatesOneBindingForEachClassInInheritenceTree() throws Exception {
        ...
        assertEquals(Lists.newArrayList(
                "com.viadeo.kasper.core.component.eventbus.KasperRoutingKeyResolverUTest$EventB",
                "com.viadeo.kasper.core.component.eventbus.KasperRoutingKeyResolverUTest$EventA"
        ), routingKeys);
    }
}
