...
public class BaseStepUTest {
    ...
    public void init_withUnknownGetterName_isKO() throws NoSuchMethodException {
        ...
        // When
        new BaseStep(TestSagaA.class.getMethod("handle", TestEvent.class), "step", "fakeGetter", idReconciler) {};
    }

    @Test
    public void init_isOK() throws NoSuchMethodException {
        new BaseStep(TestSagaA.class.getMethod("handle", TestEvent.class), "step", "getId", idReconciler) {};
    }
    ...
    public void name_returnTheMethodName() throws NoSuchMethodException {
        // Given
        Step step = new BaseStep(TestSagaA.class.getMethod("handle", TestEvent.class), "step", "getId", idReconciler);
    ...
    public void equals_withDifferentName_isKO() throws NoSuchMethodException {
        // Given
        Step step1 = new BaseStep(TestSagaA.class.getMethod("handle", TestEvent.class), "step", "getId", idReconciler);
        Step step2 = new BaseStep(TestSagaA.class.getMethod("handle2", TestEvent2.class), "step", "getId", idReconciler);
    ...
    public void equals_withSameName_withSameSupportedEvent_isOK() throws NoSuchMethodException {
        // Given
        Step step1 = new BaseStep(TestSagaA.class.getMethod("handle", TestEvent.class), "step", "getId", idReconciler);
        Step step2 = new BaseStep(TestSagaA.class.getMethod("handle", TestEvent.class), "step", "getId", idReconciler);
    ...
    public void getSagaIdentifierFrom_withUnexpectedError_returnAbsentValue() throws NoSuchMethodException {
        // Given
        Step step = new BaseStep(TestSagaA.class.getMethod("handle", TestEvent.class), "step", "getIdThrowsException", idReconciler);
        Event event = new TestEvent("42");
