 ...
 *
 * @deprecated use {@link com.viadeo.kasper.client.platform.configuration.PlatformConfiguration} instead.
 */
@Deprecated
public interface OldPlatformConfiguration {
     ...
     */
     OldKasperPlatform kasperPlatform(CommandGateway commandGateway
            ,  QueryGateway queryGateway
            ,  KasperEventBus eventBus
            ,  AnnotationRootProcessor annotationRootProcessor
     );
     OldKasperPlatform kasperPlatform();
