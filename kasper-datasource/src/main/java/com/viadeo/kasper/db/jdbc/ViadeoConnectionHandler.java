...
public class ViadeoConnectionHandler implements InvocationHandler {

    private final ViadeoDataSource ds;
    ...
    public ViadeoConnectionHandler(ViadeoDataSource commonDs) {
        ds = commonDs;
