...
public class ShardedConnectionHandler implements InvocationHandler {

    private static final String METHOD_USING_CONNECTION_PREFIX = "prepare";

    private final ShardedDataSource ds;
    ...
    public ShardedConnectionHandler(final ShardedDataSource commonDs) {
        ds = commonDs;
