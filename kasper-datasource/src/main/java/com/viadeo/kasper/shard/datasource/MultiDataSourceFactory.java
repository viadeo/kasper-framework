...
import com.viadeo.kasper.shard.settings.DispatcherSettings;
import com.viadeo.kasper.shard.settings.Dsn;
...
public class MultiDataSourceFactory implements DataSourceFactory {
  	...
  	private static final Logger LOGGER = LoggerFactory.getLogger(MultiDataSourceFactory.class);
