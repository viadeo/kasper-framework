...
public class StdQueryFactory implements IQueryFactory {
    ...
    public <T> TypeAdapter<T> create(final TypeToken<T> typeToken) {
        ...
        if (null == adapter) {
            ...
            if (null == adapter) {
                ...
                adapter = (TypeAdapter<T>) provideBeanQueryMapper((TypeToken<Class<? extends IQuery>>) typeToken);
            }
    ...
    private TypeAdapter<? extends IQuery> provideBeanQueryMapper(final TypeToken<Class<? extends IQuery>> typeToken) {
