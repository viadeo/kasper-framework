...
public class KasperClientBuilder {
    ...
    public KasperClientBuilder use(final TypeAdapter<?> adapter) {
        ...
        TypeToken<?> adapterForType = TypeToken.of(adapter.getClass()).getSupertype(TypeAdapter.class).resolveType(TypeAdapter.class.getTypeParameters()[0]);
        adapters.put(adapterForType.getType(), (TypeAdapter<Object>) adapter);
        return this;
    }
