...
public abstract class AbstractDocumentedDomainNode extends DocumentedNode {
	...
	protected AbstractDocumentedDomainNode(final KasperLibrary kl, final String type, final String pluralType) {		
	...
	public AbstractDocumentedDomainNode setDomainName(final String domainName) {
